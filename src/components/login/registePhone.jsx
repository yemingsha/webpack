...
class RegistePhone extends Component{
        ...
        fetch(urlStr, {
            ...
            .then(response=> {
                ...
                if (response.ok) {
                    ...
                    router.push({pathname:'/registeOther',state:{phone:phone}});
    ...
    render() {
        ...
        <div>
            ...
            <div style={{margin:' 5% 10%' }} className="xm">
...
RegistePhone = createForm()(RegistePhone);
export default RegistePhone;