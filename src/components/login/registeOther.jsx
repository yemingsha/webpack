...
const Message = React.createClass({
    ...
    render() {
        ...
        const errors = getFieldError('message');
        return (<div >
            <div>
...
const RePassword = React.createClass({
    ...
    render() {
        const { getFieldProps, getFieldError, isFieldValidating } = this.props.form;
        const errors = getFieldError('rePassword');
        return (<div >
            <div>
...
class RegisteOther extends Component{
    ...
    constructor(props) {
        ...
        console.log('LittleCategory   this.props=======',this.props.location.state.phone);
    ...
    sendRequest=()=> {
        ...
        let message = this.props.form.getFieldsValue().message;
        let password = this.props.form.getFieldsValue().password;
        let password5=this.md5(password);

        //http://101.200.46.114:8088/trademark/regist.do?username=15380822424&psd=1&msgcode=xxx
        let urlStr='http://101.200.46.114:8088/trademark/regist.do?username='+phone+'&msgcode='+message+'&psd='+password5;
                ...
                <div style={{margin:' 5% 10%' }}>
                    ...
                    <form >
                        ...
                        <Button className="btn" type="primary"
                                onClick={this.onSubmit}>注册</Button>
                    </form>
...
RegisteOther = createForm()(RegisteOther);
export default RegisteOther;