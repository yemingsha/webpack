...
class FogetPasswordOther extends Component{
    ...
    sendRequest=()=> {
        ...
        //let urlStr='http://101.200.46.114:8088/trademark/resetpsw.do?username=15380822424&msgcode=xxx&resetpsw=1'
        let urlStr='http://101.200.46.114:8088/trademark/resetpsw.do?username='+phone+'&msgcode='+message+'&resetpsw='+password5;
    ...
    onLeftClick=()=>{
        hashHistory.push('/fogetPasswordPhone')
    }
...
FogetPasswordOther = createForm()(FogetPasswordOther);
export default FogetPasswordOther;